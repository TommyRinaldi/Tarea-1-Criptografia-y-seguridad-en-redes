...
if pagina==1:
        ...
        username.send_keys("correonuevomailelectronico@gmail.com")
        password = browser.find_elements_by_xpath("(//input[@id='clave'])")[1].send_keys("clavecorreo1235")
        time.sleep(3)
        ...
        browser.find_element_by_name("clave").send_keys("clavecorreo1235")
        browser.find_element_by_name("claveNueva").send_keys("clavecorreo1235nueva")
        browser.find_element_by_name("claveRepetida").send_keys("clavecorreo1235nueva")
        ...
        browser.find_element_by_name("account_last_name").send_keys("correo nuevo")
        browser.find_element_by_name("password_current").send_keys("clavecorreo1235")
        browser.find_element_by_name("password_1").send_keys("clavecorreo1235nueva")
        browser.find_element_by_name("password_2").send_keys("clavecorreo1235nueva")
        time.sleep(10)
